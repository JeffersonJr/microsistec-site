...
function IndicaEGanhaPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulate sending data and getting an exclusive link code
    const uniqueCode = "MS" + Math.floor(1000 + Math.random() * 9000);
    navigate({
            ...
            <div className="max-w-xl">
              ...
              <p className="text-lg md:text-xl text-[color:var(--brand-sand)]/80 mb-8 leading-relaxed">
                ...
                <span className="inline-block mt-2 text-base">
                  O desconto é <strong className="text-white">cumulativo</strong> e você pode ter um limite de até <strong>10 indicações válidas</strong> (podendo chegar a 100% de desconto).
                </span>
              </p>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[color:var(--brand-sand)]/70">Se a imobiliária indicada contratar, você recebe 10% de desconto em uma mensalidade.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl relative border border-[color:var(--brand-clay)]/10">
              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <button
                    type="submit"
                    className="w-full mt-4 bg-[color:var(--brand-clay)] text-white hover:bg-[color:var(--brand-clay)]/90 font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition cursor-pointer shadow-lg active:scale-[0.98] border-none"
                  >
