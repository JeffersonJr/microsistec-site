    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
        ...
        <div className="prose max-w-none text-foreground/90 prose-p:leading-relaxed prose-headings:font-bold prose-a:text-[color:var(--brand-orange)] space-y-6">
          ...
          <h2 className="text-2xl mt-10 mb-4 text-foreground">1. O que são cookies?</h2>
          ...
          <h2 className="text-2xl mt-10 mb-4 text-foreground">2. Por que usamos cookies?</h2>
          <p className="text-foreground/80">
          ...
          <h2 className="text-2xl mt-10 mb-4 text-foreground">3. Tipos de cookies que usamos</h2>
          ...
          <h2 className="text-2xl mt-10 mb-4 text-foreground">4. Como posso controlar os cookies?</h2>
          <p className="text-foreground/80">
          ...
          <h2 className="text-2xl mt-10 mb-4 text-foreground">5. Alterações nesta Política</h2>
          <p className="text-foreground/80">
