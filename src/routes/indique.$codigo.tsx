        ...
        <section className="pt-32 pb-20 md:pt-40 md:pb-32 px-4 bg-[color:var(--brand-ink)] text-[color:var(--brand-sand)] relative overflow-hidden">
          ...
          <div className="container max-w-5xl mx-auto text-center relative z-10">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-white mb-6 leading-[1.1]">
              Tecnologia para imobiliárias que querem vender mais e operar
              melhor.
            </h1>
            <p className="text-xl md:text-2xl text-[color:var(--brand-sand)]/80 mb-10 max-w-3xl mx-auto leading-relaxed">
              Centralize sua operação, gere mais oportunidades e automatize seu
              atendimento com o ecossistema Microsistec.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm md:text-base font-semibold text-[color:var(--brand-teal)] mb-12">
              <span className="flex items-center gap-2">
                <Database className="w-5 h-5" /> CRM
              </span>
        ...
        <section className="py-16 md:py-24 px-4 bg-white">
          <div className="container max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[color:var(--brand-ink)] leading-[1.2]">
              <span className="text-[color:var(--brand-clay)]">
                O Site encontra.
              </span>
              <br />
              <span className="text-[#2B5250]">O Albert atende.</span>
              <br />
              O CRM organiza.
              <br />
              Sua equipe vende.
        ...
        <section className="py-20 bg-slate-50 border-y border-slate-100">
          <div className="container max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-2xl font-bold text-[color:var(--brand-ink)]">
                CRM Microsistec
              </h3>
              <p className="text-lg font-semibold text-[color:var(--brand-clay)]">
                Sua operação organizada em um só lugar.
              </p>
              <p className="text-slate-600 mb-4">
                Gerencie leads, imóveis, clientes, corretores e oportunidades
              ...
              <ul className="flex flex-col gap-3 mt-auto">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-center gap-2 text-sm text-[color:var(--brand-ink)] font-medium"
                  >
                    <CheckCircle2 className="w-5 h-5 text-[color:var(--brand-teal)] shrink-0" />{" "}
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-lg font-semibold text-[color:var(--brand-clay)]">
                Seu site não deveria apenas mostrar imóveis. Ele deveria gerar
                oportunidades.
              </p>
              <p className="text-slate-600 mb-4">
                O Site Motor V8 foi desenvolvido para imobiliárias que precisam
                de velocidade, performance e geração de leads.
              </p>
              <ul className="flex flex-col gap-3 mt-auto">
                {[
                  "Alta performance",
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-slate-600 mb-4">
                O Albert IA conversa com seus leads pelo WhatsApp, qualifica o
                atendimento e ajuda sua equipe a chegar mais rápido às melhores
                oportunidades.
              </p>
              <ul className="flex flex-col gap-3 mt-auto">
                {[
                  ...
                  "Integração com Meta",
                  "Envio automático para o CRM",
                  "Atualização dos imóveis",
                ].map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-2 text-sm text-[color:var(--brand-ink)] font-medium"
        ...
        <section id="qualificacao" className="py-24 px-4 bg-white relative">
          <div className="container max-w-3xl mx-auto relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[color:var(--brand-ink)] mb-4">
                Vamos entender melhor sua imobiliária?
              </h2>
              <p className="text-lg text-slate-600">
                Preencha os dados abaixo e nosso time apresenta a solução mais
            ...
            <div className="bg-white rounded-3xl p-6 md:p-10 shadow-2xl border border-slate-100 relative overflow-hidden">
              ...
              {isSubmitted ? (
                <div className="text-center py-16">
                  ...
                  <h3 className="text-3xl font-bold text-[color:var(--brand-ink)] mb-4">
                    Tudo certo!
                  </h3>
                  <p className="text-lg text-slate-600">
                    Nosso time entrará em contato em breve para apresentar a
                    Microsistec.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                  ...
                  <input
                    type="hidden"
                    name="origem"
                    value={`indicacao_${codigo}`}
                  />

                  <div className="space-y-5">
                    <h3 className="text-xl font-bold text-[color:var(--brand-ink)] border-b border-slate-100 pb-2">
                      Dados Principais
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          className="px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[color:var(--brand-teal)] transition"
                        />
                      </div>
                      <div className="flex flex-col gap-1.5">
                        <label className="text-sm font-semibold text-slate-700">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-sm font-semibold text-slate-700">
                        Quantos corretores trabalham atualmente na imobiliária?*
                      </label>
                      <select
                        required
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            corretores: e.target.value,
                          })
                        }
                        className="px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[color:var(--brand-teal)] transition bg-white"
                      >
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-sm font-semibold text-slate-700">
                        Atualmente vocês utilizam algum CRM imobiliário?*
                      </label>
                      <select
                        required
                        value={formData.usaCrm}
                        onChange={(e) =>
                          setFormData({ ...formData, usaCrm: e.target.value })
                        }
                        className="px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[color:var(--brand-teal)] transition bg-white"
                      >
                        <option value="" disabled>
                    ...
                    {formData.usaCrm === "Sim" && (
                      <div className="flex flex-col gap-1.5">
                        <label className="text-sm font-semibold text-slate-700">
                          Qual CRM utilizam atualmente? (Opcional)
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <>
                          QUERO CONHECER A MICROSISTEC{" "}
                          <ArrowRight className="w-6 h-6" />
                        </>
                      )}
                    </button>
                    <p className="text-center text-sm text-slate-500 mt-4">
                      Nosso time entrará em contato para entender sua operação e
