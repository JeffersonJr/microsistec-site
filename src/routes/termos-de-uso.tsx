  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32 pb-20 px-6 max-w-5xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-10 text-[color:var(--brand-orange)] tracking-tight">
          Termos e Condições
        </h1>

        <Tabs defaultValue="termos" className="w-full">
          <TabsList className="flex flex-wrap w-full justify-start h-auto p-1.5 bg-muted rounded-2xl gap-2 mb-8">
            <TabsTrigger value="termos" className="rounded-xl px-4 py-2">Termos de Uso</TabsTrigger>
            <TabsTrigger value="plataforma" className="rounded-xl px-4 py-2">Plataforma Microsistec</TabsTrigger>
            <TabsTrigger value="sites" className="rounded-xl px-4 py-2">Microsistec Sites</TabsTrigger>
            <TabsTrigger value="email" className="rounded-xl px-4 py-2">Serviço de E-mail</TabsTrigger>
            <TabsTrigger value="privacidade" className="rounded-xl px-4 py-2">Política de Privacidade</TabsTrigger>
          </TabsList>

          <TabsContent value="termos" className="prose prose-lg dark:prose-invert max-w-none focus:outline-none">
            <h2>Termos de Uso</h2>
            ...
            <p>O presente Termo de Serviço e seus Anexos, que são partes inseparáveis do presente instrumento, regulam o uso do Sistema por parte do Usuário final, doravante "Usuário".<br/>O sistema será disponibilizado online em http://microsistec.com.br, somente após o aceite expresso do Usuário, concordando com todas regras de utilização e escolhendo um dos planos disponibilizados.</p>
          ...
          <TabsContent value="plataforma" className="prose prose-lg dark:prose-invert max-w-none focus:outline-none">
            ...
            <p>A Microsistec se reserva no direito de atualizar o presente instrumento e anexos de serviços a qualquer momento, sem prévio aviso, a cada novo acesso, verifique a data de atualização firmada dos documentos, disponíveis para consulta no endereço: http://imob.online/terms.</p>
          ...
          <TabsContent value="sites" className="prose prose-lg dark:prose-invert max-w-none focus:outline-none">
            ...
            <h3>1) Cláusula Primeira – Objeto</h3>
            <p>O Microsistec Site é um serviço oferecido pela Microsistec, de uso opcional, definido pela disponibilização de 01 (um) site pronto, escolhido pelo Usuário, a partir de modelos desenvolvidos previamente pela Microsistec e publicados para seleção no endereço https://microsistec.com.br/temas;</p>
          ...
          <TabsContent value="email" className="prose prose-lg dark:prose-invert max-w-none focus:outline-none">
          ...
          <TabsContent value="privacidade" className="prose prose-lg dark:prose-invert max-w-none focus:outline-none">
            <h2>Política de Privacidade</h2>
            <p>Bem-vindo e obrigado pelo seu interesse no CRM Microsistec, nosso site em https://www.microsistec.com.br (o "Site"), e todos os sites relacionados, software para download, aplicativos móveis (incluindo aplicativos para tablets) e outros serviços fornecidos por nós e nos quais é exibido um link para esta Política de Privacidade e todas as outras comunicações com indivíduos por meios escritos ou verbais, como e-mail ou telefone, juntamente com o Site, nosso "Serviço").</p>
