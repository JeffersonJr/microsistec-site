...
export const Route = createFileRoute("/novidades")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conheça os últimos lançamentos da Microsistec: Multifunil, Banco de Leads, Check-in de Plantão, Documentos Automatizados, Relatórios e Automações." },
    ],
  }),
...
function NovidadesPage() {
  ...
  const poolLeads = [
    { id: 1, name: "Fernanda Lima", interest: "Apt 3 dorms Gonzaga · até R$ 850k", origin: "VivaReal", inactiveDays: 14, score: "Alta Intenção" },
    { id: 2, name: "Marcelo Ribeiro", interest: "Casa em Condomínio · até R$ 1.4M", origin: "Instagram Ads", inactiveDays: 22, score: "Investidor" },
    { id: 3, name: "Juliana Mendes", interest: "Studio Ponta da Praia · R$ 390k", origin: "Site Próprio", inactiveDays: 30, score: "FGTS Aprovado" },
  ];
  ...
  const docTypes = [
    { id: "termo", title: "Termo de Visita", subtitle: "Assinatura pré/pós visita de imóvel", code: "TV-2025/089", client: "Ricardo Alcantara", prop: "Rua Tolentino Filgueiras, 142 - Gonzaga", badge: "Obrigatório CRECI" },
    { id: "autorizacao", title: "Autorização de Venda", subtitle: "Exclusividade e termo de intermediação", code: "AV-2025/112", client: "Helena Prado (Proprietária)", prop: "Av. Bartolomeu de Gusmão, 45 - Santos", badge: "Comissão 6%" },
    { id: "proposta", title: "Proposta Formal", subtitle: "Condições de pagamento e entrada", code: "PF-2025/304", client: "Thiago & Patrícia Santos", prop: "Edifício Costa Marina, Apto 82", badge: "Validade 5 dias" },
    { id: "locacao", title: "Contrato de Locação", subtitle: "Minuta digital com garantia locatícia", code: "CL-2025/047", client: "Camila Duarte (Locatária)", prop: "Rua Euclides da Cunha, 88 - Pompeia", badge: "Garantia: Seguro" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <div className="bg-[color:var(--brand-ink)]/95 backdrop-blur-md border-b border-[color:var(--brand-sand)]/10 sticky top-[72px] z-40 hidden md:block">
          <div className="mx-auto max-w-7xl px-6">
            <div className="flex items-center gap-6 py-4 overflow-x-auto scrollbar-hide">
              ...
              <button onClick={() => document.getElementById('banco-de-leads')?.scrollIntoView({ behavior: 'smooth' })} className="text-[color:var(--brand-sand)]/70 hover:text-white font-semibold text-sm whitespace-nowrap transition-colors cursor-pointer border-none bg-transparent flex items-center gap-2">
                <Database className="w-4 h-4" /> Banco de Leads
              </button>
              <button onClick={() => document.getElementById('checkin')?.scrollIntoView({ behavior: 'smooth' })} className="text-[color:var(--brand-sand)]/70 hover:text-white font-semibold text-sm whitespace-nowrap transition-colors cursor-pointer border-none bg-transparent flex items-center gap-2">
                <MapPin className="w-4 h-4" /> Check-in de Plantão
              </button>
              <button onClick={() => document.getElementById('documentos')?.scrollIntoView({ behavior: 'smooth' })} className="text-[color:var(--brand-sand)]/70 hover:text-white font-semibold text-sm whitespace-nowrap transition-colors cursor-pointer border-none bg-transparent flex items-center gap-2">
        ...
        {/* 1. Multifunil */}
        <section id="multifunil" className="scroll-mt-32 mx-auto max-w-7xl px-6 py-20 md:py-28 border-b border-[color:var(--brand-ink)]/8">
        ...
        <section id="banco-de-leads" className="scroll-mt-32 mx-auto max-w-7xl px-6 py-20 md:py-28 border-b border-[color:var(--brand-ink)]/8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 bg-[color:var(--brand-sand)]/40 p-6 md:p-8 rounded-3xl border border-[color:var(--brand-ink)]/10 shadow-soft">
              <div className="flex items-center justify-between pb-4 border-b border-[color:var(--brand-ink)]/10 mb-5">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-[color:var(--brand-ink)]">Pool de Leads Disponíveis</h4>
                    <p className="text-[11px] text-muted-foreground font-mono-ui">248 oportunidades na base da imobiliária</p>
                  </div>
                </div>
                <span className="text-[10px] font-mono-ui font-bold bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded-full flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" /> Fila Livre
                </span>
              </div>

              {/* Filter pills */}
              <div className="flex gap-1.5 mb-4 overflow-x-auto scrollbar-hide pb-1">
                {["Todos", "Alto Padrão", "Inativos > 15d", "3 Dormitórios"].map((tag) => (
                  <button
                    key={tag}
                    ...
                    >
                      <div className="flex items-start justify-between gap-3 mb-2">
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-sm text-[color:var(--brand-ink)]">{lead.name}</span>
                            <span className="text-[10px] font-mono-ui bg-gray-100 text-gray-700 px-2 py-0.5 rounded-md font-medium">{lead.origin}</span>
                          </div>
                      ...
                      <div className="flex items-center justify-between pt-2.5 border-t border-gray-100 mt-2">
                        ...
                        <button
                          onClick={() => {
                            if (isClaimed) {
                              setClaimedLeads(claimedLeads.filter(id => id !== lead.id));
                            } else {
                        ...
                        >
                          {isClaimed ? (
                            <>
                              <CheckCircle2 className="w-3.5 h-3.5" /> Pescado por Você
                            </>
                          ) : (
                            <>
                              🎣 Pescar Lead
              ...
              <div className="mt-4 pt-3 border-t border-dashed border-[color:var(--brand-ink)]/15 text-center text-[11px] text-muted-foreground font-mono-ui">
                Corretores podem resgatar leads e reaquecer vendas a qualquer momento.
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 space-y-6">
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-[color:var(--brand-ink)] flex items-center gap-3 flex-wrap">
                Banco de Leads
                <span className="text-sm md:text-base font-bold bg-[color:var(--brand-orange)] text-white px-3 py-1 rounded-full uppercase tracking-wider">Novo</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Nenhum contato é esquecido ou desperdiçado. O <strong>Banco de Leads</strong> cria uma pool central inteligente com todos os leads não atendidos, parados ou da base geral, permitindo que os corretores mais proativos <strong>pesquem oportunidades</strong> e fechem vendas no seu próprio ritmo.
              </p>
              <ul className="space-y-4 pt-2">
                {[
        ...
        <section id="checkin" className="scroll-mt-32 mx-auto max-w-7xl px-6 py-20 md:py-28 border-b border-[color:var(--brand-ink)]/8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Distribuição de leads 100% justa e focada em quem está pronto para responder. Com o <strong>Check-in de Plantão</strong>, o corretor sinaliza presença pelo app ou na sede da imobiliária e entra imediatamente na fila do rodízio.
              </p>
              <ul className="space-y-4 pt-2">
                {[
              ...
              <div className="bg-white rounded-2xl border border-[color:var(--brand-ink)]/8 p-5 shadow-sm space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-sm text-[color:var(--brand-ink)]">Rodrigo Mendes</h4>
                      <p className="text-[11px] text-muted-foreground font-mono-ui">Corretor de Vendas · CRECI 184920</p>
                    </div>
                  </div>
                  <span className={`text-[10px] font-mono-ui font-bold px-2.5 py-1 rounded-full flex items-center gap-1.5 ${isCheckedIn ? "bg-emerald-100 text-emerald-800" : "bg-gray-100 text-gray-600"}`}>
                    <span className={`w-2 h-2 rounded-full ${isCheckedIn ? "bg-emerald-500 animate-ping" : "bg-gray-400"}`} />
                ...
                <div className="p-4 rounded-xl bg-gradient-to-br from-[color:var(--brand-ink)] to-[#1c2433] text-[color:var(--brand-sand)] space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono-ui text-white/60">GPS Validado ✓</span>
                  </div>

                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-base font-bold text-white">Sua posição na fila</p>
                      <p className="text-xs text-[color:var(--brand-sand)]/70">
                        {isCheckedIn ? "Você é o próximo a receber lead (#1)" : "Faça check-in para entrar na fila"}
                      </p>
                    </div>
                    <button
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-emerald-50/60 border border-emerald-200/60 text-xs">
                    ...
                    <span className="font-mono-ui text-emerald-700 font-bold">Próximo da Vez</span>
                  </div>

                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-gray-50 border border-gray-100 text-xs">
                    <span className="font-semibold text-gray-700 flex items-center gap-2">
                      <span className="w-5 h-5 rounded-full bg-gray-300 text-gray-700 flex items-center justify-center font-bold text-[10px]">2</span>
                      Carla Silveira
                    </span>
                    <span className="font-mono-ui text-muted-foreground">Aguardando</span>
                  </div>

                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-gray-50 border border-gray-100 text-xs opacity-75">
                    <span className="font-semibold text-gray-700 flex items-center gap-2">
                      <span className="w-5 h-5 rounded-full bg-gray-300 text-gray-700 flex items-center justify-center font-bold text-[10px]">3</span>
                      Bruno Castro
                    </span>
                    <span className="font-mono-ui text-muted-foreground">Em Atendimento</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="documentos" className="scroll-mt-32 mx-auto max-w-7xl px-6 py-20 md:py-28 border-b border-[color:var(--brand-ink)]/8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 bg-[color:var(--brand-sand)]/40 p-6 md:p-8 rounded-3xl border border-[color:var(--brand-ink)]/10 shadow-soft">
              ...
              <div className="grid grid-cols-2 gap-2 mb-6">
                {docTypes.map((doc) => (
                  ...
                  >
                    <p className="font-bold text-xs text-[color:var(--brand-ink)]">{doc.title}</p>
              ...
              <div className="bg-white rounded-2xl border border-[color:var(--brand-ink)]/10 p-6 shadow-sm relative overflow-hidden space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-xs text-[color:var(--brand-ink)]">{activeDoc.title}</span>
                  </div>
                ...
                <div className="space-y-2.5 text-xs text-gray-700">
                  <div className="p-2.5 bg-gray-50 rounded-lg space-y-1">
                    <span className="text-[10px] font-mono-ui text-muted-foreground uppercase">Cliente / Interessado</span>
                    <p className="font-semibold text-gray-900">{activeDoc.client}</p>
                  </div>
                  <div className="p-2.5 bg-gray-50 rounded-lg space-y-1">
                    <span className="text-[10px] font-mono-ui text-muted-foreground uppercase">Imóvel Vinculado</span>
                    <p className="font-semibold text-gray-900">{activeDoc.prop}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <FileDown className="w-3.5 h-3.5" /> {docGenerated ? "PDF Gerado com Sucesso ✓" : "Gerar Documento"}
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 text-center text-[11px] text-muted-foreground font-mono-ui">
                Campos e dados de clientes e imóveis são preenchidos de forma 100% automática pelo CRM.
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Chega de perder tempo preenchendo contratos e termos manualmente no Word. Crie, gere e envie <strong>contratos, propostas, autorizações de venda e locação e termos de visita</strong> em segundos com dados integrados ao CRM.
              </p>
              <ul className="space-y-4 pt-2">
                {[
        ...
        <section id="integracoes" className="scroll-mt-32 mx-auto max-w-7xl px-6 py-20 md:py-32 border-b border-[color:var(--brand-ink)]/8">
