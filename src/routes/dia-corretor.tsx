...
export const Route = createFileRoute("/dia-corretor")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Descubra as novidades que preparamos para o Dia do Corretor. O futuro do corretor de imóveis chegou na Microsistec." },
    ],
  }),
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <div className="flex flex-col lg:col-span-7">
              ...
              <p className="text-2xl text-foreground/80 leading-relaxed mb-8">
                Neste Dia do Corretor, preparamos novidades exclusivas para quem deseja vender mais, perder menos tempo com burocracia e oferecer um atendimento de excelência. Cadastre-se para descobrir.
              </p>
              ...
              <div className="mt-12 hidden lg:block">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {solutions.map((solution) => {
                      ...
                      return (
                        <div key={solution.id} className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-[color:var(--brand-ink)]/5 shadow-sm hover:shadow-md transition-shadow">
                          ...
                          <h3 className="text-xl font-bold text-[color:var(--brand-ink)] mb-2 flex items-center gap-2">
                            ...
                            {solution.slug === 'locacao' && (
                              <span className="text-[10px] uppercase font-bold bg-[color:var(--brand-orange)]/20 text-[color:var(--brand-orange)] px-2 py-0.5 rounded-full">Em breve</span>
                            )}
                          </h3>
                          <p className="text-sm text-foreground/70 leading-relaxed">{solution.shortDesc}</p>
                        </div>
                      )
                    })}
                 </div>
              ...
              <div className="bg-white rounded-[2rem] p-8 md:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-[color:var(--brand-ink)]/5 relative z-10 min-h-[450px] flex flex-col justify-center overflow-hidden">
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <form 
                    ...
                    onSubmit={async (e) => {
                      ...
                      try {
                        ...
                        console.error("[DiaCorretor] Erro ao enviar lead:", err);
                  ...
                  >
                    ...
                    >
                      {isSubmitting ? "Enviando..." : "Quero as novidades exclusivas"}
                    </button>
                  </form>
          ...
          <div className="mt-16 lg:hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
               {solutions.map((solution) => {
                 const Icon = getIconComponent(solution.iconName);
                 return (
                   <div key={solution.id} className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-[color:var(--brand-ink)]/5 shadow-sm">
                     <div className="w-12 h-12 bg-[color:var(--brand-orange)]/10 text-[color:var(--brand-orange)] rounded-xl flex items-center justify-center mb-4">
                       <Icon className="w-6 h-6" />
                     </div>
                     <h3 className="text-xl font-bold text-[color:var(--brand-ink)] mb-2 flex items-center gap-2">
