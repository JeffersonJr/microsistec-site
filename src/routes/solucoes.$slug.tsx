  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        {
          title: override
            ? `${override.title} | Microsistec`
            : sol
              ? `${sol.title} | Microsistec`
              : "Soluções Microsistec",
        },
        {
          name: "description",
          content: override
            ...
            : sol
              ? sol.shortDesc
              : "Explore as soluções de inteligência imobiliária da Microsistec.",
        },
      ],
    };
  },
...
const howItWorksData: Record<
  string,
  { title: string; steps: { n: string; title: string; desc: string }[] }
> = {
  crm: {
    ...
    steps: [
      {
        n: "01",
        title: "Cadastre e organize",
        desc: "Adicione imóveis, proprietários e clientes em minutos. O sistema sugere categorias e otimiza as mídias automaticamente.",
      },
      {
        n: "02",
        title: "Cruze e qualifique",
        desc: "O Smart Match identifica os leads com maior chance de compra para cada imóvel novo cadastrado e dispara alertas em tempo real.",
      },
      {
        n: "03",
        title: "Acompanhe e feche",
        desc: "Visualize toda a jornada no funil, controle propostas, gere contratos em PDF e registre o fechamento com histórico completo.",
      },
    ],
  },
  "albert-ia": {
    ...
    steps: [
      {
        n: "01",
        title: "Lead entra no WhatsApp",
        desc: "O Albert detecta automaticamente novos leads de qualquer fonte: portais, site, Instagram Ads ou número direto da imobiliária.",
      },
      {
        n: "02",
        title: "Qualificação inteligente",
        desc: "Em conversa natural, o Albert coleta renda, entrada, FGTS, localização desejada e urgência, sem menus engessados.",
      },
      {
        n: "03",
        title: "Repasse e agendamento",
        desc: "O lead qualificado é transferido ao corretor certo com toda a ficha preenchida e visita já agendada no CRM.",
      },
    ],
  },
  app: {
    ...
    steps: [
      {
        ...
        desc: "Disponível para iOS e Android. Faça login com suas credenciais do CRM Microsistec e sincronize tudo automaticamente.",
      },
      {
        n: "02",
        title: "Receba leads instantaneamente",
        desc: "Notificações push em tempo real ao chegar um novo lead de qualquer canal. Atenda antes que o concorrente.",
      },
      {
        n: "03",
        title: "Trabalhe onde estiver",
        desc: "Acesse o funil, catálogo, histórico e agenda de visitas. Compartilhe lâminas no WhatsApp com um toque.",
      },
    ],
  },
  /* === BACKUP MULTI-FUNIL ===
  ...
  */
  funil: {
    ...
    steps: [
      ...
      {
        n: "02",
        title: "Envios com um clique",
        desc: "Encaminhe as opções de imóveis selecionadas diretamente para o e-mail ou WhatsApp do cliente em segundos.",
      },
      {
        n: "03",
        title: "Agenda e Termo de Visita",
        desc: "Marque as visitas na agenda do corretor e gere automaticamente o termo de visita em PDF para assinatura.",
      },
    ],
  },
  integracoes: {
    ...
    steps: [
      {
        n: "01",
        title: "Ative os portais",
        desc: "Selecione os portais parceiros no painel. Imóveis são enviados automaticamente via XML sem nenhum cadastro manual.",
      },
      {
        n: "02",
        title: "Conecte WhatsApp e Meta",
        desc: "Configure a API oficial do WhatsApp Business e os Lead Ads do Facebook/Instagram. Leads chegam direto no CRM.",
      },
      {
        n: "03",
        title: "Acompanhe tudo num painel",
        desc: "Visualize de onde vêm os leads, qual portal converte mais e quanto cada campanha gera em oportunidades reais.",
      },
    ],
  },
  "sites-template": {
    ...
    steps: [
      {
        ...
        desc: "São 15 templates de alta conversão. Escolha o que melhor combina com a identidade da sua imobiliária.",
      },
      {
        n: "02",
        title: "Personalize",
        desc: "Adicione logo, cores, textos e imóveis da sua carteira. Tudo sincronizado automaticamente com o CRM.",
      },
      {
        n: "03",
        title: "Publique no seu domínio",
        desc: "Configure o DNS e em minutos seu site imobiliário está no ar com SEO otimizado e formulários de captação ativos.",
      },
    ],
  },
  "sites-v8": {
    ...
    steps: [
      {
        ...
        desc: "Nossa equipe faz um diagnóstico completo: nicho, público, concorrentes e objetivos de conversão da imobiliária.",
      },
      {
        n: "02",
      ...
      },
      {
        ...
        desc: "Site SSR nativo, nota máxima no PageSpeed, CDN Cloudflare e monitoramento contínuo de performance e SEO.",
      },
    ],
  },
  rodizio: {
    ...
    steps: [
      {
        ...
        desc: "Defina a sequência de corretores, especialidades por tipo de imóvel e janelas de plantão de atendimento.",
      },
      {
        n: "02",
        title: "Lead chega, sistema distribui",
        desc: "Ao entrar um lead, o sistema identifica o próximo da fila, envia por WhatsApp e aguarda resposta com timeout configurável.",
      },
      {
        n: "03",
        title: "Métricas de equidade",
        desc: "Relatórios em tempo real mostram quantos leads cada corretor recebeu, tempo de resposta e taxa de conversão.",
      },
    ],
  },
};
...
function SolutionHowItWorks({ slug }: { slug: string }) {
  ...
  return (
    <section
      id={`como_funciona_${slug}`}
      data-gtm-section="como_funciona_solucao"
...
function SolutionMetrics({ slug }: { slug: string }) {
  ...
  return (
    <section
      id={`metricas_${slug}`}
      data-gtm-section="metricas_solucao"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {metrics.map((m, i) => (
          ...
          >
            ...
            <div className="text-[10px] text-[color:var(--brand-sand)]/50 font-mono-ui relative z-10">
              {m.sub}
            </div>
          </div>
        ))}
...
> = {
  crm: [
    {
      icon: Building2,
      title: "Imobiliárias em crescimento",
      desc: "Que precisam organizar a carteira e escalar a equipe de corretores sem perder o controle.",
    },
    {
      icon: Key,
      title: "Corretores autônomos",
      desc: "Que gerenciam múltiplos clientes e imóveis e querem profissionalizar o atendimento.",
    },
    {
      icon: Target,
      title: "Gestores e sócios",
      desc: "Que precisam de visibilidade real das métricas sem depender de planilhas.",
    },
  ],
  "albert-ia": [
    {
      icon: Zap,
      title: "Imobiliárias com alto volume de leads",
      desc: "Que recebem dezenas de leads por dia e não conseguem atender todos em tempo hábil.",
    },
    {
      icon: Moon,
      title: "Operações sem plantão 24h",
      desc: "Que perdem leads fora do horário comercial ou nos fins de semana.",
    },
    {
      icon: BarChart3,
      title: "Incorporadoras e lançamentos",
      desc: "Que precisam qualificar e filtrar leads antes de acionar a equipe comercial.",
    },
  ],
  app: [
    {
      icon: Car,
      title: "Corretores na rua",
      desc: "Que passam o dia fazendo visitas e precisam atualizar o CRM sem voltar ao escritório.",
    },
    {
      icon: Smartphone,
    ...
    {
      icon: ZapIcon,
      title: "Profissionais de alta performance",
      desc: "Que querem ser o primeiro a responder um lead e fechar mais rápido que a concorrência.",
    },
  ],
  funil: [
    {
      icon: Trophy,
      title: "Imobiliárias multi-nicho",
      desc: "Que trabalham com MCMV, alto padrão e locação ao mesmo tempo e precisam de métricas separadas por processo.",
    },
    {
      icon: Users,
      title: "Gestores com times segmentados",
      desc: "Que têm equipes distintas por produto e querem acompanhar a performance de cada time de forma independente.",
    },
    {
      icon: Crosshair,
      title: "Incorporadoras e lançamentos",
      desc: "Que têm um processo comercial para pré-lançamento totalmente diferente das vendas do estoque disponível.",
    },
  ],
  integracoes: [
    {
      icon: Globe,
      title: "Imobiliárias com múltiplos portais",
      desc: "Que atualizam imóveis manualmente em vários portais e perdem horas toda semana.",
    },
    {
      icon: Smartphone,
      title: "Operações com tráfego pago",
      desc: "Que investem em Facebook/Instagram Ads e precisam capturar leads direto no CRM.",
    },
    {
      icon: MessageCircle,
      title: "Imobiliárias que usam WhatsApp",
      desc: "Que querem centralizar atendimento via WhatsApp integrado ao histórico do cliente.",
    },
  ],
  "sites-template": [
    {
      icon: Rocket,
      title: "Imobiliárias que precisam lançar rápido",
      desc: "Que precisam de um site profissional no ar em um dia sem esperar desenvolvimento customizado.",
    },
    {
      icon: Lightbulb,
      title: "Corretores autônomos",
      desc: "Que querem ter um portal próprio de imóveis com formulário de captação e SEO básico.",
    },
    {
      icon: Building,
      title: "Imobiliárias de médio porte",
      desc: "Que buscam custo-benefício alto com templates modernos e integração imediata ao CRM.",
    },
  ],
  "sites-v8": [
    {
      icon: Star,
      title: "Alto padrão e lançamentos",
      desc: "Que trabalham com imóveis de luxo e precisam de um site que transmita exclusividade.",
    },
    {
      icon: Target,
      title: "SEO como estratégia",
      desc: "Que querem capturar leads orgânicos do Google com conteúdo e performance técnica impecáveis.",
    },
    {
      icon: Crown,
      title: "Grandes imobiliárias",
      desc: "Com catálogos extensos, múltiplas equipes e necessidade de integrações customizadas.",
    },
  ],
  rodizio: [
    {
      icon: Scale,
      title: "Equipes com conflito de leads",
      desc: "Onde corretores brigam por leads ou alguns ficam sem atendimento e outros sobrecarregados.",
    },
    {
      icon: Clock,
      title: "Plantão de atendimento",
      desc: "Que precisam distribuir leads automaticamente conforme o horário e disponibilidade de cada corretor.",
    },
    {
      icon: BarChart3,
      title: "Gerentes focados em dados",
      desc: "Que querem medir tempo de resposta e taxa de conversão por corretor para tomada de decisão.",
    },
  ],
};
...
function SolutionForWho({ slug }: { slug: string }) {
  ...
  return (
    <section
      id={`para_quem_${slug}`}
      data-gtm-section="para_quem_solucao"
      className="mx-auto max-w-7xl px-6 pb-14 md:pb-20"
    >
      <div className="mb-8">
        <span className="stamp text-[#2B5250] text-[10px]">
...
const faqData: Record<string, { q: string; a: string }[]> = {
  crm: [
    {
      q: "Quanto tempo leva para migrar dados do meu sistema atual?",
      a: "A migração é feita pela nossa equipe de onboarding em 3 a 9 dias úteis, dependendo da plataforma de origem e da qualidade dos dados exportados. Importamos imóveis, clientes e histórico de forma segura sem perda de dados.",
    },
    {
      q: "Funciona para imobiliária de locação e venda?",
      a: "Sim. O CRM possui módulos para gestão de venda. Para locação, consulte nossa equipe para verificar a disponibilidade dos módulos de locação e as opções de integração.",
    },
    {
      q: "Quantos usuários posso cadastrar?",
      a: "Depende do plano. Temos planos para corretores autônomos até grandes imobiliárias com equipes ilimitadas. Consulte nossa tabela de planos.",
    },
    {
      q: "O sistema funciona offline?",
      a: "A plataforma web requer conexão. O app mobile mantém histórico e dados em cache offline, sincronizando ao reconectar.",
    },
    {
      q: "Tem integração com portais como ZAP e Viva Real?",
      a: "Sim. Integramos com mais de 40 portais nacionais e regionais, Facebook Lead Ads, Google e WhatsApp Business. Tudo centralizado no CRM.",
    },
  ],
  "albert-ia": [
    {
      q: "Quanto tempo leva para configurar o Albert?",
      a: "O processo de onboarding dura em média de 5 a 15 dias úteis, dependendo da complexidade da operação. Nossa equipe coleta seu script, tone of voice e catálogo de imóveis para treinar o Albert.",
    },
    {
    ...
    },
    {
      ...
      a: "Atualmente via WhatsApp Business (API oficial) e no site da imobiliária. Novas integrações estão em roadmap.",
    },
    {
      q: "O que acontece se o lead fizer uma pergunta que o Albert não sabe?",
      a: "O Albert reconhece limitações e transfere o lead para um corretor humano de forma transparente, sem frustrar o cliente.",
    },
    {
      q: "O Albert funciona 24 horas por dia, inclusive fins de semana?",
      a: "Sim. O Albert atende 365 dias por ano, 24 horas por dia, sem pausas, feriados ou plantões extras.",
    },
  ],
  app: [
    {
      q: "O app é gratuito?",
      a: "O app está incluído nos planos do CRM Microsistec sem custo adicional. Disponível para iOS e Android.",
    },
    {
      q: "Posso usar o app sem o CRM web?",
      a: "Não. O app é uma extensão mobile do CRM e requer conta ativa na plataforma.",
    },
    {
      q: "O app sincroniza em tempo real?",
      a: "Sim. Qualquer ação no app é sincronizada instantaneamente com a plataforma web e vice-versa.",
    },
    {
      q: "Funciona no iPhone e Android?",
      a: "Sim. O app está disponível na App Store (iOS) e Google Play (Android), com paridade de funcionalidades.",
    },
    {
      q: "Como recebo notificações de novos leads?",
      a: "Por push notifications nativas do sistema operacional. Você recebe o alerta mesmo com o app fechado.",
    },
  ],
  funil: [
    {
      q: "Quantos funis posso criar?",
      a: "Não há limite. Você pode criar quantos funis quiser: venda de imóveis residenciais, locação, lançamentos, MCMV, alto padrão, comercial e muito mais.",
    },
    {
      q: "As etapas de cada funil são diferentes?",
      a: "Sim. Cada funil tem suas próprias etapas totalmente independentes. O funil de MCMV pode ter 'Simulação CEF' e 'Aprovação Bancária', enquanto o alto padrão tem 'Visita Técnica' e 'Carta de Crédito'. Você nomeia do jeito que a sua equipe fala.",
    },
    {
      q: "As métricas de conversão são separadas por funil?",
      a: "Sim. Cada funil gera seus próprios relatórios de conversão, tempo médio por etapa e previsão de receita. Isso evita que dados de MCMV (alta conversão, ticket baixo) distorçam os resultados de alto padrão (baixa conversão, ticket alto).",
    },
    {
      q: "Posso ter corretores diferentes por funil?",
      a: "Sim. Cada funil pode ter responsáveis configurados de forma independente, permitindo que você tenha equipes especializadas por tipo de produto.",
    },
    {
      q: "O funil funciona em conjunto com o Albert IA?",
      a: "Sim. O Albert qualifica o lead e o registra automaticamente no funil correto baseado no interesse demonstrado. Um lead interessado em MCMV vai para o funil MCMV; um lead de alto padrão vai para o funil certo.",
    },
  ],
  integracoes: [
    {
      q: "Quais portais estão disponíveis para integração?",
      a: "Mais de 40 portais, incluindo ZAP Imóveis, Viva Real, OLX, Imovelweb, Mercado Livre, Chaves na Mão e portais regionais.",
    },
    {
      q: "A sincronização é bidirecional?",
      a: "Sim. Imóveis cadastrados no CRM são enviados para os portais. Leads recebidos nos portais chegam ao CRM automaticamente.",
    },
    {
      q: "Preciso pagar extra pelo WhatsApp Business?",
      a: "A integração com a API oficial do WhatsApp tem um custo de conversação conforme a tabela da Meta. A integração com nosso sistema não tem custo adicional.",
    },
    {
      q: "Funciona com Facebook Lead Ads?",
      a: "Sim. Leads gerados em campanhas do Facebook chegam direto ao CRM sem precisar exportar planilhas. A integração com Instagram Lead Ads está em breve.",
    },
    {
      q: "Os imóveis sobem automaticamente nos portais?",
      a: "Sim. Ao cadastrar ou atualizar um imóvel no CRM, as alterações são enviadas automaticamente para todos os portais configurados.",
    },
  ],
  "sites-template": [
    {
      q: "Preciso de conhecimento técnico para instalar?",
      a: "Não. Nossa equipe faz a instalação completa. Você só precisa ter um domínio registrado e apontar o DNS conforme nossa orientação.",
    },
    {
      q: "Posso trocar de tema depois?",
      a: "Sim. A migração de tema é feita pela equipe técnica sem perda de dados. Disponível mediante solicitação.",
    },
    {
      q: "O site atualiza os imóveis automaticamente do CRM?",
      a: "Sim. Toda vez que você adiciona ou atualiza um imóvel no CRM, o site reflete as mudanças automaticamente.",
    },
    {
      q: "Os formulários do site vão para o CRM?",
      a: "Sim. Todos os formulários de contato e interesse do site criam leads automaticamente no CRM com origem identificada.",
    },
    {
      q: "O site é otimizado para SEO?",
      a: "Sim. Todos os temas são otimizados com meta tags, sitemap, URLs amigáveis e velocidade de carregamento adequada para Google.",
    },
  ],
  "sites-v8": [
    {
  ...
  rodizio: [
    {
      q: "O rodízio funciona para qualquer quantidade de corretores?",
      a: "Sim. Funciona desde equipes de 2 corretores até grandes operações com dezenas de profissionais em múltiplas filiais.",
    },
    {
      q: "O que acontece se o corretor não responder ao lead?",
      a: "Após o timeout configurado, o sistema passa o lead automaticamente para o próximo da fila e notifica o gestor sobre o no-show.",
    },
    {
      q: "Posso configurar regras por especialidade?",
      a: "Sim. Você pode definir que leads de lançamentos vão para corretores específicos, e leads de locação para outros.",
    },
    {
      q: "O corretor em férias ou folga é pulado?",
      a: "Sim. O corretor pode marcar seu status como 'férias' ou 'folga' e o sistema o exclui automaticamente da fila de distribuição.",
    },
    {
      q: "Como funciona o rodízio fora do horário comercial?",
      a: "Você configura um plantão de atendimento. Fora do plantão, o Albert IA pode atender e qualificar o lead até o próximo corretor disponível.",
    },
  ],
};
...
function SolucaoDetalhe() {
  ...
  const getFeaturesTitle = (s: string, defaultTitle: string) => {
    switch (s) {
      case "crm":
        return "Gestão Imobiliária e Automação de Ponta a Ponta";
      case "app":
        return "O poder do CRM na palma da sua mão";
      /* case "funil": return "Acelere negócios com um funil de vendas inteligente"; */
      case "funil":
        return "Acelere negócios com um funil de vendas inteligente";
      case "integracoes":
      ...
      case "sites-v8":
        return "Presença digital única e de altíssima performance";
      case "rodizio":
        return "Distribuição justa e automática de leads";
      default:
        return `Recursos e Funcionalidades do ${defaultTitle}`;
    }
  };
  ...
  const getFeatureCardTitle = (slug: string, idx: number) => {
    const titles: Record<string, string[]> = {
      ...
      funil: [
        ...
        "Termo de Visita em PDF",
      ],
      integracoes: [
        "Carga Automatizada nos Portais",
      ...
      "sites-v8": [
        ...
        "Segurança e Nuvem Resiliente",
      ],
      rodizio: [
        "Fila Round-Robin Inteligente",
      ...
      locacao: [
        "Gestão de Contratos e Alertas",
        "Reajustes Automáticos (IGP-M/IPCA)",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        {/* Solution Hero */}
        <section
          id={`hero_solucao_${sol.slug}`}
          data-gtm-section="hero_dobra_1"
          className="relative overflow-hidden bg-hero pt-28 pb-20 md:pt-36 md:pb-28 border-b border-[color:var(--brand-ink)]/8"
        >
                  ...
                  {sol.slug === "albert-ia" ? (
                    <div className="bg-background/80 backdrop-blur-sm rounded-2xl p-2.5 border border-[color:var(--brand-ink)]/10 shadow-soft flex items-center justify-center max-w-[180px]">
                      <img
                        src="/albert-logo.png"
                        alt="Albert IA"
                        title="Albert IA - Inteligência Artificial"
                        width={100}
                        height={32}
                        fetchPriority="high"
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        ...
                        if (
                          ...
                          window.open(
                            "https://apps.apple.com/us/app/microsistec-leads/id1550404156",
                            "_blank",
                          );
                        } else {
                          window.open(
                            "https://play.google.com/store/apps/details?id=br.com.microsistec.mercury&hl=pt_BR",
                            "_blank",
                          );
                        }
                      }}
        ...
        <section
          id={`recursos_${sol.slug}`}
          data-gtm-section="recursos_solucao"
        ...
        {sol.slug === "integracoes" && (
          <section
            id="portais_integracoes"
            data-gtm-section="portais_integracoes"
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
                <div className="space-y-6 max-w-lg">
                  ...
                  <p className="text-muted-foreground text-base leading-relaxed">
                    Sincronize seus imóveis automaticamente com os maiores
                    players do mercado. Sem cadastros manuais repetitivos, sem
                    perda de tempo.
                  </p>
                </div>
              ...
              {filteredPortals.length > 0 ? (
                ...
                <div className="text-center py-16 border border-dashed border-[color:var(--brand-ink)]/15 rounded-2xl space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tente buscar por termos diferentes ou selecione outra
                    categoria.
                  </p>
                </div>
              )}
        ...
        {/* CTA section */}
        <section
          id={`cta_final_${sol.slug}`}
          data-gtm-section="cta_final_solucao"
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(60% 50% at 80% 0%, oklch(0.7 0.19 45 / 0.5), transparent 60%), radial-gradient(50% 40% at 20% 100%, oklch(0.623 0.106 195.8 / 0.4), transparent 60%)",
            }}
          />
          ...
          <div className="relative mx-auto max-w-4xl px-6 text-center space-y-7">
            ...
            <p className="text-lg text-[color:var(--brand-sand)]/60 max-w-md mx-auto">
              Experimente toda a inteligência e automação da Microsistec. Leva
              menos de 30 segundos para configurar.
            </p>
...
function AlbertIASubSection({ openModal }: { openModal: () => void }) {
  ...
  return (
    <>
      <section
        id="demo_albert_ia"
        data-gtm-section="demo_albert_ia"
      ...
      >
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-base text-muted-foreground leading-relaxed">
              Interaja com o simulador de WhatsApp ao lado. O Albert atende com
              empatia linguística, faz cruzamento de dados, qualificação
              bancária de crédito e agenda visitas integradas diretamente no CRM
              da sua imobiliária, 24 horas por dia.
            </p>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm leading-relaxed">
                <div className="p-3 bg-red-50/40 rounded-xl border border-red-100">
                  ...
                  Menu engessado de botões, sem contexto humano e frustrante
                ...
                <div className="p-3 bg-emerald-50/40 rounded-xl border border-emerald-100">
                  ...
                  Diálogos dinâmicos livres, tom consultivo, entendimento de
                  renda, entrada e agendamento inteligente.
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 bg-[color:var(--brand-sand)]/60 rounded-3xl p-4 border border-[color:var(--brand-ink)]/15 shadow-soft relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 bg-[color:var(--brand-ink)] text-[color:var(--brand-sand)] p-4 rounded-2xl mb-4 shadow-sm relative">
              <div className="w-10 h-10 rounded-full bg-[color:var(--brand-sand)]/20 p-1 flex items-center justify-center">
                <img
                  src="/albert-logo.png"
                  alt="Albert"
                  title="Albert - Assistente Virtual"
                  width={28}
                  height={28}
                  loading="lazy"
                  decoding="async"
              ...
              <div>
                ...
                <div className="text-[10px] text-[color:var(--brand-sand)]/70">
                  Atendimento Imobiliário Oficial
                </div>
              </div>
            ...
            <div className="mt-4 p-2 bg-background/80 rounded-2xl border border-[color:var(--brand-ink)]/10 min-h-[60px] flex flex-wrap items-center justify-center gap-2">
              ...
              chatHistory[chatHistory.length - 1].options!.length > 0 ? (
      ...
      <section
        id="diferenciais_albert_ia"
        data-gtm-section="diferenciais_albert_ia"
        className="mx-auto max-w-7xl px-6 pb-20 md:pb-28"
      >
        <div className="space-y-6 mb-14 text-center max-w-2xl mx-auto">
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            ...
            atua como um clone do seu melhor SDR. Uma solução montada sob medida
            para sua imobiliária com tom de voz, conhecimento dos
            empreendimentos e roteiro comercial exclusivos.
          </p>
        </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 space-y-2">
                <h3 className="text-3xl md:text-4xl font-extrabold tracking-tight">
                  Conheça o Albert pessoalmente
                </h3>
                <p className="text-base text-[color:var(--brand-sand)]/70 max-w-lg">
                  Converse agora mesmo com o Albert pelo WhatsApp e veja na
                  prática como ele transforma o atendimento da sua imobiliária.
                </p>
              </div>
            </div>
            <button
...
const templates: ThemeTemplate[] = [
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06164147/elegant-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06164724/city-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06164800/beach-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06164915/land-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165001/dothouse-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165035/dothouse-dark-1-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165100/clean-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165133/center-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165352/flash-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165418/lighting-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165505/center-house-1-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165532/business-scaled.jpg",
  ...
  },
  {
    ...
    image:
      "https://d2xnmiivr6f5qr.cloudfront.net/wp-content/uploads/2024/08/06165553/master-scaled.jpg",
...
function SitesTemplateSubSection({ openModal }: { openModal: () => void }) {
  const [selectedTheme, setSelectedTheme] =
    React.useState<ThemeTemplate | null>(null);

  return (
    <section
      id="catalogo_temas"
      data-gtm-section="catalogo_temas"
      className="mx-auto max-w-7xl px-6 pb-20 md:pb-28 border-t border-[color:var(--brand-ink)]/10 pt-16"
    >
      <div className="space-y-6 mb-12 text-center max-w-2xl mx-auto">
        ...
        <p className="text-base text-muted-foreground leading-relaxed">
          Temos 15 temas de altíssima conversão integrados à nossa plataforma,
          prontos para rodar no seu próprio domínio com velocidade extrema e SEO
          avançado.
        </p>
      </div>
              ...
              <div className="space-y-2">
                <div className="flex flex-wrap gap-1 mb-2">
                  {tpl.tags.slice(0, 2).map((tg, idx) => (
                    <span
                      key={idx}
                      className="bg-[color:var(--brand-ink)]/10 text-[color:var(--brand-ink)]/80 text-[8px] font-mono-ui font-bold px-2 py-0.5 rounded-full uppercase tracking-wider"
                    >
                      {tg}
                    </span>
                  ))}
    ...
    <div className="flex flex-col items-center">
      <div className="relative w-24 h-14 overflow-hidden flex justify-center">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-center">
          <span className="text-3xl font-bold font-mono-ui" style={{ color }}>
            {displayValue}
          </span>
        </div>
      </div>
      <span className="mt-3 text-[10px] uppercase font-bold text-muted-foreground text-center leading-tight h-8 max-w-[80px]">
        {label}
      </span>
    </div>
  );
          ...
          >
            <div>
              ...
              <div className="flex items-center justify-between pb-4 border-b border-dashed border-[color:var(--brand-ink)]/10 mb-4">
                ...
                <span
                  className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-pulse block"
                  title="Site em produção estável"
                />
              </div>
              ...
              <div className="flex flex-wrap gap-1 mb-4">
                {client.tags.map((tg, tIdx) => (
                  <span
                    key={tIdx}
                    className="bg-[color:var(--brand-ink)]/5 text-foreground text-[8px] font-mono-ui font-semibold px-2 py-0.5 rounded-full uppercase"
                  >
                    {tg}
                  </span>
                ))}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground">
              Primeira linha brasileira de sites imobiliários SSR nativos.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground">
              Certificação HTTPS, CDN Cloudflare Edge e proteção anti-DDoS.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground">
              Otimização automática de WebP e imagens sob demanda.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 pb-20 md:pb-28 border-t border-[color:var(--brand-ink)]/10 pt-16">
      ...
      <div className="space-y-6 mb-14 text-center max-w-2xl mx-auto">
        ...
        <p className="text-base text-muted-foreground leading-relaxed">
          O CRM da Microsistec vai muito além de um simples cadastro. É uma
          plataforma completa de gestão imobiliária com módulos integrados que
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-center mb-14">
        <div className="space-y-6">
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            No momento em que um novo imóvel é inserido no CRM, o algoritmo
            varre sua carteira de leads e notifica por e-mail e WhatsApp os
            compradores com potencial de fechamento correspondente.
          </p>
          <ul className="space-y-3 text-sm text-foreground/80 font-mono-ui">
            <li className="flex items-center gap-2">
              <Check className="w-4 h-4 text-emerald-500" /> Match por bairro,
              faixa financeira, dormitórios e vagas.
            </li>
            <li className="flex items-center gap-2">
              <Check className="w-4 h-4 text-emerald-500" /> Disparo automático
              de lâminas e catálogos customizados.
            </li>
            <li className="flex items-center gap-2">
              <Check className="w-4 h-4 text-emerald-500" /> Relatórios
              gerenciais de aceitação e visitas do imóvel.
            </li>
          </ul>
        </div>
        ...
        <div className="bg-[color:var(--brand-sand)]/60 rounded-3xl p-6 border border-[color:var(--brand-ink)]/15 relative overflow-hidden shadow-soft flex flex-col gap-4">
          ...
          <div className="p-4 bg-background rounded-2xl border border-[color:var(--brand-ink)]/10 shadow-sm relative">
            <div className="absolute top-2 right-2 stamp text-emerald-600 text-[8px] font-bold">
              DISPONÍVEL
            </div>
          ...
          <div className="p-4 bg-background rounded-2xl border border-[color:var(--brand-ink)]/10 shadow-sm relative">
            <div className="absolute top-2 right-2 stamp text-indigo-600 text-[8px] font-bold">
              LEAD QUALIFICADO
            </div>
            <h4 className="font-extrabold text-base">Jefferson Junior</h4>
            <div className="text-sm text-muted-foreground mt-1">
              Preferencia: Gonzaga/Boqueirão · R$ 900.000 max.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Base de conhecimento com mais de 200 artigos, tutoriais e vídeos
              de suporte.
            </p>
          </div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Cursos e treinamentos exclusivos para sua equipe dominar cada
      ...
      <div className="bg-[color:var(--brand-ink)] text-[color:var(--brand-sand)] p-8 md:p-10 rounded-3xl relative overflow-hidden">
        ...
        <div className="relative flex flex-col md:flex-row items-center gap-6 md:gap-10">
          <div className="flex-1 space-y-3">
            ...
            <p className="text-base text-[color:var(--brand-sand)]/70 max-w-lg">
              Marca d'água inteligente, relatórios gerenciais, exportação de
              dados, controle de exclusividade, histórico completo de
              atendimentos, fichas de visita, contratos PDF e dezenas de outros
    ...
    <section className="mx-auto max-w-7xl px-6 pb-20 md:pb-28 border-t border-[color:var(--brand-ink)]/10 pt-16">
      <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="w-[260px] h-[520px] bg-[color:var(--brand-ink)] rounded-[40px] p-3 border-4 border-[color:var(--brand-ink)] shadow-elev relative overflow-hidden flex flex-col">
            ...
            <div className="bg-background w-full h-full rounded-[30px] p-4 flex flex-col overflow-hidden relative text-sm">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-[color:var(--brand-ink)]/10 pt-4 mb-2">
                <span className="font-mono-ui font-extrabold text-[10px]">
                  Microsistec App
                </span>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <p className="text-base text-muted-foreground leading-relaxed">
            O corretor não trabalha sentado o dia todo. Ele está na rua,
            visitando imóveis e fechando negócios. Nosso app coloca todos os
            leads, o funil de vendas completo, o catálogo de imóveis com
            endereço para visita e todo o histórico de atendimento sempre
            disponível no bolso dele.
          </p>
...
export function FunilSubSectionMulti() {
  const funnels = [
    {
      ...
      stages: [
          ...
          leads: [
            {
              ...
              desc: "Cobertura Riviera - Vista Mar",
              value: "R$ 3.8M",
              tag: "",
            },
            {
              name: "Ana Carvalho",
              desc: "Casa em condomínio fechado",
              value: "R$ 2.2M",
              tag: "Albert MQL",
            },
          ],
        ...
        },
        {
          ...
          leads: [
            {
              name: "Juliana Bianchi",
              desc: "Penthouse Gonzaga",
              value: "R$ 2.9M",
              tag: "Negociando",
            },
          ],
      ...
      stages: [
        {
          ...
          leads: [
            {
              name: "Maria Santos",
              desc: "Apto 2q Praia Grande",
              value: "R$ 280K",
              tag: "Faixa 2",
            },
            {
              name: "José Oliveira",
              desc: "Casa 3q - São Vicente",
              value: "R$ 220K",
              tag: "FGTS OK",
            },
          ],
      ...
      stages: [
        {
          ...
          leads: [
            {
              name: "Gabriel Torres",
              desc: "Apto 2q Gonzaga",
              value: "R$ 3.200/mês",
              tag: "App",
            },
            {
              name: "Letícia Ramos",
              desc: "Sala Comercial - Centro",
              value: "R$ 4.500/mês",
              tag: "Portais",
            },
          ],
      ...
      stages: [
        {
          ...
          leads: [
            {
              name: "Camila Rocha",
              desc: "Torres Riviera - Unid. 804",
              value: "R$ 890K",
              tag: "VIP lista",
            },
            {
              name: "Diego Vieira",
              desc: "Edifício Soleil - Unid. 1102",
              value: "R$ 1.2M",
              tag: "Reserva",
            },
          ],
      ...
      stages: [
          ...
          leads: [
            {
              ...
              desc: "Proprietário - Apto Gonzaga",
              value: "R$ 800K",
              tag: "Frio",
            },
            {
        ...
        },
        {
          ...
          leads: [
            {
              name: "Luciana Reis",
              desc: "Terreno Aparecida",
              value: "R$ 600K",
              tag: "Aguardando Matrícula",
            },
          ],
        },
        {
  ...
  return (
    <section
      id="funil_interativo_multi"
      data-gtm-section="funil_interativo_multi"
    ...
    >
      ...
      <div className="space-y-4 mb-10 max-w-2xl">
        ...
        <p className="text-base text-muted-foreground leading-relaxed">
          Alto padrão, MCMV, locação e lançamentos têm jornadas completamente
          diferentes. Crie funis independentes com etapas, responsáveis e
          métricas próprias para cada processo.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {funnel.stages.map((stage, si) => (
          <div
            key={si}
            className="bg-[color:var(--brand-sand)]/25 rounded-xl p-3 border border-[color:var(--brand-ink)]/6 space-y-2"
          >
            <div className="flex items-center justify-between pb-2 border-b border-[color:var(--brand-ink)]/6">
              <span className="text-[9px] font-bold font-mono-ui uppercase text-muted-foreground truncate pr-1">
                {stage.name}
              </span>
              <span className="bg-[color:var(--brand-ink)]/8 text-[color:var(--brand-ink)] text-[9px] font-bold px-1.5 py-0.5 rounded-full shrink-0">
                {stage.count}
              </span>
            </div>
            {stage.leads.map((lead, li) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  {lead.tag && (
                    <span
                      className={`text-[8px] font-bold px-1.5 py-0.5 rounded-full ${funnel.color}`}
                    >
                      {lead.tag}
                    </span>
                  )}
      ...
      <div className="mt-8 p-5 rounded-2xl bg-[color:var(--brand-ink)] text-[color:var(--brand-sand)] flex flex-col md:flex-row items-start md:items-center gap-4">
        <div className="flex-1">
          ...
          <p className="text-base text-[color:var(--brand-sand)]/80 leading-relaxed">
            Crie quantos funis precisar. Etapas, responsáveis e métricas
            totalmente independentes por processo de negócio.
          </p>
        </div>
        <div className="flex gap-2 shrink-0 text-[10px] font-mono-ui">
          <span className="px-3 py-1.5 rounded-full bg-white/5 text-[color:var(--brand-sand)]/70">
            ∞ Funis
          </span>
          <span className="px-3 py-1.5 rounded-full bg-white/5 text-[color:var(--brand-sand)]/70">
            ∞ Etapas
...
export function FunilSubSection() {
  ...
  const formatVGV = (val: number) => {
    if (val >= 1000000)
      return `R$ ${(val / 1000000).toFixed(1).replace(".0", "")}M`;
    if (val >= 1000) return `R$ ${(val / 1000).toFixed(0)}K`;
    return `R$ ${val}`;
  };

  const totalLeads = stages.reduce((acc, stage) => acc + stage.leads.length, 0);
  const totalVGV = stages.reduce(
    (acc, stage) =>
      acc + stage.leads.reduce((sum, lead) => sum + parseVGV(lead.value), 0),
    0,
  );

  return (
    <section
      id="funil_kanban_simples"
      data-gtm-section="funil_kanban_simples"
      className="mx-auto max-w-7xl px-6 pb-20 md:pb-28 border-t border-[color:var(--brand-ink)]/8 pt-16"
    >
      <div className="space-y-4 mb-10 max-w-2xl">
        <span className="stamp text-[#2B5250] text-[10px]">
        ...
        <p className="text-base text-muted-foreground leading-relaxed">
          Tenha controle absoluto do seu pipeline de vendas e locações.
          Movimente oportunidades de negócio em um Kanban totalmente visual e
          customizado para a sua operação.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 overflow-x-auto pb-4 select-none">
        {stages.map((stage, si) => {
          const columnVGV = stage.leads.reduce(
            (sum, lead) => sum + parseVGV(lead.value),
            0,
          );
          return (
            <div
            ...
            >
              ...
              {stage.leads.map((lead, li) => (
                ...
                >
                  ...
                  <p className="text-[9px] text-muted-foreground leading-tight pointer-events-none">
                    {lead.desc}
                  </p>
      ...
      <div className="mt-4 p-5 rounded-2xl bg-[color:var(--brand-ink)] text-[color:var(--brand-sand)] flex flex-col md:flex-row items-start md:items-center gap-4">
        <div className="flex-1">
          ...
          <p className="text-base text-[color:var(--brand-sand)]/80 leading-relaxed">
            Cruze o perfil do seu lead com o estoque de imóveis, envie opções
            por WhatsApp e gere termos de visita automaticamente. Tudo no mesmo
            lugar.
          </p>
        </div>
      </div>
...
function RodizioSubSection() {
  ...
  return (
    <section
      id="simulador_rodizio"
      data-gtm-section="simulador_rodizio"
      className="mx-auto max-w-7xl px-6 pb-20 md:pb-28 border-t border-[color:var(--brand-ink)]/10 pt-16"
    >
      {/* Header */}
      <div className="space-y-6 mb-14 max-w-2xl">
        ...
        <p className="text-muted-foreground text-base leading-relaxed">
          Veja como o sistema distribui leads de forma justa e automática entre
          os corretores disponíveis. Clique em "Novo Lead" para simular um
          contato entrando de um portal imobiliário.
        </p>
      </div>
        ...
        <div className="md:col-span-3 rounded-2xl border border-[color:var(--brand-ink)]/10 bg-[color:var(--brand-sand)]/20 overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-[color:var(--brand-ink)]/8 bg-[color:var(--brand-ink)] text-[color:var(--brand-sand)]">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-mono-ui font-bold uppercase tracking-widest">
                Fila de Corretores · Ao Vivo
              </span>
            </div>
            <span className="text-[10px] font-mono-ui text-[color:var(--brand-sand)]/50">
              {queue.length} corretores
            </span>
          </div>
          ...
          <div className="rounded-2xl border border-[color:var(--brand-ink)]/10 bg-[color:var(--brand-sand)]/20 p-5 space-y-4">
            ...
            {distributed && (
              <div className="p-3 rounded-xl border border-green-500/30 bg-green-50/40 text-sm text-green-700 font-medium">
                ✓ <strong>{distributed.lead}</strong> enviado para{" "}
                <strong>{distributed.corretor}</strong> no WhatsApp!
              </div>
            )}
          </div>
